...
function getContractPayment() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__index_js___default.a.contractPay(send_data)
...
function sendShareEvent() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__index_js___default.a.shareEvent(send_data)

}
__WEBPACK_IMPORTED_MODULE_0__index_js___default.a.sendShareEvent = sendShareEvent
...
function sendShowVideoAdEvent() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__index_js___default.a.showVideoAdEvent(send_data)

}
__WEBPACK_IMPORTED_MODULE_0__index_js___default.a.sendShowVideoAdEvent = sendShowVideoAdEvent
...
if (!global.jCoinchat) {
    ...
    var jCoinchat = {
            ...
            shareEvent : function(res) {
                var data = {};
                invoke('share_event', res, function() {
                    data._complete = function(result) {
                        // delete res.type
                        console.log('调用完成');
                        if (res.complete) {
